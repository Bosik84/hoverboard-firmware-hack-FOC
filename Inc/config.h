...
#define N_MOT_MAX       800            // [rpm] Maximum motor speed limit
...
// ############################ VARIANT_HOVERCAR SETTINGS ############################
  ...
  #undef  CTRL_MOD_REQ
  #define CTRL_MOD_REQ            SPD_MODE  // HOVERCAR works best in TORQUE Mode. VOLTAGE mode is preffered when freewheeling is not desired when throttle is released.
  #define CONTROL_ADC             0         // use ADC as input. Number indicates priority for dual-input. Disable CONTROL_SERIAL_USART2, FEEDBACK_SERIAL_USART2, DEBUG_SERIAL_USART2!
 ...
 // #define DUAL_INPUTS                       // ADC*(Primary) + Sideboard_R(Auxiliary). Uncomment this to use Dual-inputs
  ...
  #define MULTI_MODE_DRIVE                  // This option enables the selection of 3 driving modes at start-up using combinations of Brake and Throttle pedals (see below)
      ...
      #define MULTI_MODE_DRIVE_M1_RATE  270
      #define MULTI_MODE_M1_I_MOT_MAX   7
      #define MULTI_MODE_M1_N_MOT_MAX   70
     ...
     // ADVANCED MODE:    Power ON + Brake [pressed] + Throttle [pressed]
      ...
      #define MULTI_MODE_M3_I_MOT_MAX   9
      #define MULTI_MODE_M3_N_MOT_MAX   100
...
#define MULTIPLE_TAP_NR           1 * 2       // [-] Define tap number: MULTIPLE_TAP_NR = number_of_taps * 2, number_of_taps = 1 (for single taping), 2 (for double tapping), 3 (for triple tapping), etc...
